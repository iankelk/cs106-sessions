...
### 1(b) Best Subset Regression for Life Expectancy (20 pts)
...
lambda_1se
```
Recall that in lasso regression, $\lambda$ is thstrength of the penalty** on the size of the coefficients.
